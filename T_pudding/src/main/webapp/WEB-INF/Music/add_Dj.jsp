		...
		<div class="container">
			...
			<nav id="nav">
				<ul>
					...
					<li class="active"><a href="puddinglist.ad">푸딩DJ</a></li>
...
<form action="addDj.ms" method="post" >
	<table border="1" align="center" cellspacing="0" width="100%">
		<tr>
		<th style="width: 20%;"><font size="5" >테마 명</font></th>
			<td><input type="text" name="dj_code" style="width: 100%;height: 55.98438px;" placeholder="테마을 입력하세요." ></td>
		</tr>
		<tr>
		<th style="width: 20%;"><font size="5" >노래 선택</font></th>
			<td	>
		<c:forEach items="${lists}" var="music">
			<input type="checkbox" name="dj_list" value="${music.music_title }" style="height: 30px;"><font size="5"> ${music.music_title }</font>
		...
		<tr>
			<td colspan="2" align="center"><input type="submit" value="추가하기">
				...
				onclick="location.href='Djlist.ms'">
			</td>
		</tr>
	</table>
</form>
